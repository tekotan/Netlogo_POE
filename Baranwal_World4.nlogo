...
to setup
  ...
  ;; set patches from -1 below to black
  ask patches with [pxcor < -1] [set pcolor black]
  ;; set patches from -14 below to yello
  ask patches with [pxcor < -14] [set pcolor yellow]
  ;; create
@#$#@#$#@
GRAPHICS-WINDOW
210
